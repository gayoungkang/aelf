        ...
        <div class="board">
            <div class="board-1">
                <table cellpadding="0" cellspacing="0">
                    <tr height="56">
                        <td colspan="5" style="font-size: 16px; font-weight: 500; border-bottom:1px solid #e0e0e0; padding:10px 20px;" class="notice-td-1"><%=ni.getNiTitle() %></td>
                    </tr>
                    <tr height="53">
                        ...
                        <td style="border-bottom:1px solid #e0e0e0;"><span style="padding:0 10px;">｜</span><%=nf.format(ni.getNiView()) %>명</td>
                        <td width="335" style="border-bottom:1px solid #e0e0e0;"></td>
                    </tr>
                    <tr height="190">
                        <td class="notice_content" colspan="5" style="letter-spacing: -0.8px; vertical-align: top; word-break:break-all;"><%=ni.getNiContent() %></td>
                    </tr>
                    <tr>
                    	<td class="notice-like-wrap" colspan="5">
                    		<img src="img/notice-like.png" onMouseOver="this.src='img/notice-like-on.png'" onMouseOut="this.src='img/notice-like.png'" onclick="javascript:likeHandler(<%=ni.getNiNo() %>, 'notice_info', -1)" alt="" />
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    <tr height="10">
                    	...
                    	<%if("desc".equals(sortType)) { %>
                    		<button style="width: 100px; padding: 0px;" onclick="javascript:location.href='notice.lf?menu=notice&mode=view&ni_no=<%=ni.getNiNo() %>&sort_type=asc'">날짜 순서로</button>
                    	<%} else { %>
                    		<button style="width: 100px; padding: 0px;" onclick="javascript:location.href='notice.lf?menu=notice&mode=view&ni_no=<%=ni.getNiNo() %>&sort_type=desc'">날짜 역순으로</button>
                    	<%} %>
                    	</td>
                    </tr>
                    <%} %>
							...
							<table cellpadding="0" cellspacing="0" style="width: 100%;">
								<tr>
									...
									<%if(reply.getNrDelete()==0) { %>
										<button onclick="javascript:likeHandler(<%=reply.getNrNo() %>, 'notice_reply', <%=reply.getUiNo() %>)">좋아요</button>&nbsp;&nbsp;
