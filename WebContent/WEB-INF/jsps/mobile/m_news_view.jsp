        ...
        <div class="notice notice-on">
            ...
            <div class="notice-top-wrap">
                <div class="notice-top">
                    <p class="notice-title"><%=newsInfo.getNewsTitle() %></p>
                    <div class="notice-top-info-wrap">
                        <div class="notice-top-info">
                            ...
                            <p>조회수</p>
                            <p><%=nf.format(newsInfo.getNewsView()) %>명</p>
                        </div>
                    </div>
                    <div class="notice-tx"><%=newsInfo.getNewsContent() %></div>
                    <div class="notice-top-like">
                        <img src="m-img/notice-like.png" alt="" onclick="javascript:likeHandler(<%=newsInfo.getNewsNo() %>, 'news_info', -1)" />
			...
			<%if(reply.getNrGroupLayer()==0) { %>
                        <div class="notice-re-mid">
							...
							<%if(reply.getNrDelete()==0) { %>
								<span class="notice-re-like" onclick="javascript:likeHandler(<%=reply.getNrNo() %>, 'newws_reply', <%=reply.getUiNo() %>)">좋아요</span>
                        ...
                        <div class="notice-re-mid">
                            <div class="notice-re-mid-wrap">                            
                            	<div class="notice-re-mid">
		                            ...
		                            <div class="notice-re-mid-reaction">
		                            <%if(reply.getNrDelete()==0) { %>
										<span class="notice-re-like" onclick="javascript:likeHandler(<%=reply.getNrNo() %>, 'news_reply', <%=reply.getUiNo() %>)">좋아요</span>
										<%if(uiNo!=-1 && uiNo==reply.getUiNo()) { %>
										<span class="notice-re-like" onclick="javascript:deleteReply(<%=reply.getNrNo() %>)">삭제하기</span>
										<%} %>
									<%} %>
