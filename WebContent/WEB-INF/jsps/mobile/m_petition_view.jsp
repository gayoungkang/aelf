       ...
       <div class="notice notice-on">
           ...
           <div class="notice-top-wrap">
               <div class="notice-top">
                   <p class="notice-title"><%=pi.getPiTitle() %></p>
                   <div class="notice-top-info-wrap">
                       <div class="notice-top-info">
                           ...
                           <p>조회수</p>
                           <p><%=nf.format(pi.getPiView()) %>명</p>
                       </div>
                   </div>
                   <div class="notice-tx"><%=pi.getPiContent() %></div>
                   
                   <%if("".equals(pi.getPiReply())==false) { %>
                   <div class="petition-re-wrap">
                       <p class="petition-re-title">답변 내용</p>
                       <p class="petition-re-tx"><%=pi.getPiReply().replaceAll("\n", "<br/>") %></p>
                   </div>
                   <%} %>
                   
                   <div class="notice-top-like">
                       <img src="m-img/notice-like.png" alt="" onclick="javascript:likeHandler(<%=pi.getPiNo() %>, 'petition_info', <%=pi.getUiNo() %>)" />
                       <span><%=nf.format(likeCnt) %></span>
                   </div>
                   <div class="notice-sns-wrap">
                       <div class="notice-sns">
                           <img src="m-img/sns-kakao.png" alt="" />
                           <img src="m-img/sns-twitter.png" alt="" />
                           <img src="m-img/sns-facebook.png" alt="" />
                           <img src="m-img/sns-naver.png" alt="" />
                           <img src="m-img/sns-telegram.png" alt="" />
                       </div>
                   </div>
