...
function onSubmit(){
	...
	var title = document.getElementById('pi_title').value;
	...
	<jsp:include page="../main_top.jsp"></jsp:include>
        ...
        <div class="notice">           
            ...
            <div style="width: 100%; height: auto; clear: both; padding-top: 20px;">
                <h4 style="padding-left: 20px;">청원 신청</h4>
                <form action="petition.lf" method="post" onsubmit="javascript:return onSubmit()">
                	<input type="hidden" name="mode" value="add_petition" />
	                ...
	                <table style="width: 950px; table-layout: fixed; margin: 0 auto;">
						<tr style="border-bottom: 1px solid lightgray;">
							...
							<td style="width: 800px;"><input type="text" readonly="readonly" class="input-style" value="<%=piAuthor %>" id="pi_author" name="pi_author" /></td>
						</tr>
						<tr style="border-bottom: 1px solid lightgray;">
							<td style="width: 150px;">제목</td>
							<td style="width: 800px;"><input type="text" class="input-style" id="pi_title" name="pi_title"  /></td>
						</tr>
						<tr style="border-bottom: 1px solid lightgray;">
						...
						<tr height="50px;">
							<td colspan="2">
								...
								<button type="button" class="btn-default" style="width: 50px; height: 30px;" onclick="javascript:history.go(-1)">취소</button>
							</td>
						</tr>
					</table>
				</form>
