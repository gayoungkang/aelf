    ...
    <div class="login-wrap">
        <div class="login">
            ...
            <table cellpadding="0" cellspacing="0" class="login-sns-wrap">
                ...
                <!-- 
                <tr height="60">
                	<td class="login-sns-box" onclick="javascript:facebookLogin()"><img src="img/sns-fb.png" /><span>페이스북</span> 계정으로 로그인</td>
                </tr>
                 
                <tr height="10"></tr>
                -->
                <tr height="60">
                	<td class="login-sns-box" onclick="javascript:kakaoLogin()"><img src="img/sns-kt.png" /><span>카카오톡</span> 계정으로 로그인</td>
                </tr>
                <!-- 
                <tr height="10"></tr>
                <tr height="60">
                	<td class="login-sns-box"><img src="img/sns-tw.png" /><span>트위터</span> 계정으로 로그인</td>
                </tr>
                 
                <tr height="10"></tr>
                <tr height="60">
                	<td class="login-sns-box" id="naverIdLogin"><img src="img/sns-nv.png" /><span>네이버</span> 계정으로 로그인</td>
                </tr>
                -->
                <tr height="10"></tr>
                <tr height="60">
                	<td class="login-sns-box" id="googleLogin"><img src="img/sns-gg.png" /><span>구글</span> 계정으로 로그인</td>
                </tr>
            </table>
            </form>
        </div>
...
<script>  
 Kakao.init("b601367bfdb186a8c9edfbdca61fc824");
  ...
  var startApp = function() {
    gapi.load('auth2', function(){
      ...
      auth2 = gapi.auth2.init({
        client_id: '937014656755-k88iug0lf033vgkj2hhbumstueaep06l.apps.googleusercontent.com',
